...
<section class="ls-form register">
        <div class="row gy-0 a-center">
            <div class="col-sm-6">
                @if ($bottomBanner = getBannerByPosition('proLeft'))
            ...
            <div class="col-sm-6">
                <div class="content">
                    ...
                    <h4>{{translate (getPageContent('register_header')) }}</h4>
                    
                <form method="POST" action="{{ route('userRegister') }}" class="login100-form validate-form">
                        @csrf
                        @if ($errors->any())
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-field">
                                    ...
                                    <input type="text" name="last_name" id="Familyname" placeholder="{{translate (getPageContent('register_filed2')) }}" value="{{ $user->last_name ?? '' }}" required="" aria-invalid="true" class="is-invalid" aria-describedby="username-error">
                                </div>
                                <!-- input field -->
                            </div>
                            <div class="col-md-6">
                ...
                <div class="banner-container">
                    @if ($bottomBanner = getBannerByPosition('Bottom'))
                        @if ($bottomBanner['site_url'])
                            <a href="{{ $bottomBanner['site_url'] }}" target="_blank">
                    ...
                    <br>
                    <div class="banner-container">
                        @if ($bottomBanner = getBannerByPosition('Bottom2'))
                        @if ($bottomBanner['site_url'])
                            <a href="{{ $bottomBanner['site_url'] }}" target="_blank">
                                <img src="{{ $bottomBanner['image_url'] }}" class="img-fluid w-100 banner-image" alt="Bottom Banner">
                            </a>
                ...
                <br>
                <div class="banner-container">
                    @if ($bottomBanner = getBannerByPosition('Bottom3'))
                    @if ($bottomBanner['site_url'])
                        <a href="{{ $bottomBanner['site_url'] }}" target="_blank">
                            <img src="{{ $bottomBanner['image_url'] }}" class="img-fluid w-100 banner-image" alt="Bottom Banner">
                        </a>
