...
<div class="main-content demo-content">
  <div class="marquee-area">
                  <ul>
                    ...
                    <li><p><marquee behavior="" direction="">{{translate('Verified members can use the My Web menu to
                      create a one-page website or portfolio using built-in widgets and
                      themes. This is a no-code solution similar to WordPress.')}}</marquee></p></li>
                  </ul>
        </div>
              <div class="textt">
