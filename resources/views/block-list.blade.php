...
<div class="container-fluid px-md-5">
    ...
    <div class="network-header">
        ...
        <div class="network-header-links">
            <ul>
                ...
                <a href="{{route('pendingList')}}"><li>{{ translate('Contact Requests') }}</li></a>
                <a href="{{route('blockList')}}"><li class="selected">{{ translate('Blocked') }}</li></a>
            </ul>
        </div>
    </div>
    ...
    <div class="favorite-contacts">
        <h5>{{ translate('Block List') }}</h5>
        <div class="row">
            @foreach ($blockedUsers as $friendData)
                ...
                <div class="single-fav-contact">
                    ...
                    <div class="dropdown-new">
                        <ul class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="{{ route('friendshipAction', ['friendId' => encrypt($friendData['friend']->id), 'status' => encrypt('unblock')]) }}">
                                {{translate('Unblock')}}
                            </a>
                        </ul>
                    </div>
                    ...
                    <div class="network-msg-dlt">
                        ...
                        <a class="msg-btn" href="{{ route('friendshipAction', ['friendId' => encrypt($friendData['friend']->id), 'status' => encrypt('unblock')]) }}">{{translate('Unblock')}}</a>
                    </div>
                </div>
            </div>
            @endforeach
