                     ...
                     <form action="{{route('admin-services.update')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="  card-header d-flex justify-content-between align-items-center text-center newcardheader" style="background:#00B2FF;border-radius:12px;height:4pc;">
                           <h5 class="text-left" style="margin-top: -1%; text-align: left;">
                              <span style="position: relative; top: 10px; left: 1pc">Edit Services</span>
                           </h5>
                        </div>
                           ...
                           <div class="card-body">
                              <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="icon" value="" placeholder="mbri-idea" value="{{ old('icon', $service->icon) }}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-sm-12 mb-2">
                                    <div class="form-group">
                                    	<p>Title <small class="text-danger">(*)</small></p>
                                    	<input type="text" name="title" placeholder="Title" id="title"  value="{{ old('title', $service->title) }}"  required class="form-control">
                                    </div>
                                </div>
                                <div class="col-sm-12 mb-2">
                                    <div class="form-group">
                                    	<p>Description <small class="text-danger">(*)</small></p>
                                    	<textarea name="description" class="form-control" rows="5" placeholder="Description" id="description">{{ old('description', $service->description) }}</textarea>
                                    </div>
                                </div>
                                <div class="col-sm-12 mb-2">
