...
<div class="container-fluid px-md-5">
    ...
    <div class="network-header">
        ...
        <div class="network-header-links">
            <ul>
                <a href="{{route('bestFriends')}}"><li class="selected">{{ translate('Favourite Contact') }}</li></a>
    ...
    <div class="favorite-contacts">
        ...
        <div class="row">
            @foreach ($allBestFriends as $friendData)
            <div class="col-md-4 col-sm-6">
                <div class="single-fav-contact">
                    ...
                    <div class="network-msg-dlt">
                        ...
                        <a class="msg-btn" href="{{ route('match.details', ['userId' => encrypt($friendData['friend']->id), 'feature' => 'chat']) }}">{{translate('Message')}}</a>
                    </div>
                </div>
            </div>
            @endforeach
