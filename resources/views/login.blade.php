        ...
        <div class="row a-center">
            ...
            <div class="col-sm-6">
                <div class="content">
                    ...
                    <form method="POST" action="/logincheck" class="login100-form validate-form">
                        @csrf
                        ...
                        <div class="input-field">
                            ...
                            <input type="password" name="password" id="username" placeholder="{{translate (getPageContent('password_placeholder')) }}" required="" aria-invalid="true" class="is-invalid" aria-describedby="username-error">
                         </div>
                        <!-- input field -->
                        <div class="check">
